...
namespace webapi.event_.Controllers
{
    ...
    public class ComentariosEventosController : ControllerBase
    {
        ...
        // TASK representa uma função assincrona que retorna valor 
        [HttpPost]
        public async Task<IActionResult> Post (ComentariosEventos comentario)
        {
            try
            {
                ...
                //AWAIT - aguarde o anterior acontecer para retornar

                //verificar se o texto analisado tem alguma serevidade 
